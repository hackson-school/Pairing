...
>(({ children, className = "", pageNumber, side = "left", isCoverStyle = false }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={`w-full h-full p-7 sm:p-9 flex flex-col justify-between select-none relative overflow-y-auto ${
    ...
    >
      ...
      {pageNumber && (
        <div
          className={`pt-4 mt-auto border-t flex items-center justify-between text-[11px] font-sans ${
...
export default function BookApp({ onResetToCover }: BookAppProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-3 sm:p-8 select-none bg-[#F0EEE9]">
      ...
      {/* 本の見開きコンテナ */}
      <div className="relative w-full max-w-[940px] flex justify-center perspective-[2000px]">
        {/* 中央の背表紙シャドウ */}
        ...
        <HTMLFlipBook
          ...
          className="shadow-[0_25px_60px_-15px_rgba(0,0,0,0.22)] rounded-2xl overflow-hidden"
          style={{}}
          startPage={0}
          drawShadow={true}
          flippingTime={800}
        ...
        >
          ...
          <BookPage pageNumber={1} side="left" isCoverStyle={true}>
            <div className="space-y-6 pt-4 text-center">
              <span className="font-sans text-[10px] tracking-[0.25em] text-[#C4BEB5] uppercase block">
                Grind & Confectionery
              </span>
              <h2 className="font-display font-light italic text-2xl sm:text-3xl text-[#FDFCFB] tracking-tight leading-tight">
                お菓子と飲み物の手帖
              </h2>
              <div className="w-10 h-px bg-[#8C532B] mx-auto" />
            ...
            <div className="text-center pb-2">
              <p className="font-sans text-[11px] text-[#C4BEB5]">
                右のページでお菓子を記してください 👉
              </p>
            </div>
          </BookPage>
            ...
            <div className="space-y-5 pt-2">
              ...
              <div className="p-4 rounded-xl bg-[#F5F2EB] border border-[#E8E2D9] space-y-1.5">
                ...
                <ul className="text-[11px] text-charcoal-700 space-y-1">
                  <li>• ページの端をマウスでドラッグすると本がめくれます</li>
                  <li>• 下のボタンを押しても自動で次のページへ進みます</li>
                </ul>
              </div>
              ...
              <div className="pt-2">
                <button
                  ...
                  className="btn-lift w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-sans font-medium text-xs text-cream-50 bg-[#1C1917] shadow-premium"
                >
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2 flex gap-2">
                <button
                  ...
                  className="btn-lift flex items-center justify-center gap-1 px-4 py-3.5 rounded-xl font-sans font-medium text-xs border border-cream-300 bg-[#FAF8F4] text-charcoal-600"
                >
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="btn-lift flex-1 flex items-center justify-center gap-2 py-3.5 rounded-xl font-sans font-medium text-xs text-cream-50 bg-[#1C1917] shadow-premium disabled:opacity-85 transition-all"
                >
                  {isLoading ? (
          ...
          <BookPage pageNumber={5} side="left">
            {result ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-center p-8 space-y-3">
                <Coffee className="w-8 h-8 text-charcoal-300 mx-auto" />
                <p className="font-display italic text-sm text-charcoal-500">
                  前のページでお菓子と飲み物を選び、<br />鑑定ボタンを押すとここに記されます
                </p>
              </div>
            )}
          </BookPage>
          ...
          <BookPage pageNumber={6} side="right">
            {result ? (
              <div className="space-y-4">
                ...
                <div className="flex gap-2 pt-2">
                  <button
                    ...
                    disabled={isSharing}
                    className="btn-lift flex-1 flex items-center justify-center gap-1.5 py-3 rounded-xl border border-cream-300 bg-[#FAF8F4] text-xs font-medium text-charcoal-800 shadow-premium disabled:opacity-75"
                  >
                    {isSharing ? (
                      <div className="flex items-center gap-1.5">
                        <div className="w-3.5 h-3.5 border-2 border-charcoal-400 border-t-charcoal-900 rounded-full animate-spin" />
                        <span>画像を生成中...</span>
                      </div>
                    ) : sharedSuccess ? (
                  ...
                  <button
                    ...
                    disabled={isSharing}
                    className="btn-lift flex items-center justify-center gap-1.5 px-3 py-3 rounded-xl border border-cream-300 bg-[#FAF8F4] text-xs font-medium text-charcoal-700 shadow-premium"
                    title="SNSで共有"
                  >
              ...
              <div className="h-full flex flex-col items-center justify-center text-center p-8">
                <p className="font-display italic text-charcoal-400">鑑定結果が記されるのをお待ちください</p>
              </div>
            )}
          </BookPage>
        </HTMLFlipBook>
